AFRAME.registerComponent("tour", {
      ...
      const thumbNailsRef = [
        {
          id: "ironman",
          title: "ironman",
          url: "./assets/thumbnails/ironman.webp",
        },
        {
          id: "spiderman",
          title: "spiderman",
  ...
  
        {
          id: "moonknight",
          title: "moonknight",
          url: "./assets/thumbnails/moonknight.jpg",
        },
        {
          id: "thor",
          title: "thor",
    ...
    createBorder : function(position, id){
      ...
      entityEl.setAttribute("geometry", {premitive : "ring", radiusInner : 9, radiusOuter : 10});
    ...
    createThumbNail : function(item){
      const entityEl = document.createElement("a-entity");
      entityEl.setAttribute("visible", true);
      entityEl.setAttribute("geometry", {premitive : "circle", radius : 9});
